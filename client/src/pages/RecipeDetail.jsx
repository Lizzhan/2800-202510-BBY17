  ...
  useEffect(() => {
    const fetchAIRecipe = async () => {
      try {
        ...
        const ingRes = await fetch(`https://two800-202510-bby17.onrender.com/api/allingredients/${userId}`, {
          credentials: 'include',
        });
        const ingredients = await ingRes.json();

        // Send ingredients to the backend AI to generate a funny recipe
        const aiRes = await fetch('https://two800-202510-bby17.onrender.com/api/funnyRecipe', {
          method: 'POST',
