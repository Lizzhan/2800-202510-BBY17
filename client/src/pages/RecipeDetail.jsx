  ...
  useEffect(() => {
    const fetchAIRecipe = async () => {
      try {
        ...
        const ingRes = await fetch(`http://ec2-99-79-7-165.ca-central-1.compute.amazonaws.com:3000/api/allingredients/${userId}`, {
          credentials: 'include',
        });
        const ingredients = await ingRes.json();

        // Send ingredients to the backend AI to generate a funny recipe
        const aiRes = await fetch('http://ec2-99-79-7-165.ca-central-1.compute.amazonaws.com:3000/api/funnyRecipe', {
          method: 'POST',
