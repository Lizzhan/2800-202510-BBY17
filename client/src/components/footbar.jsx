      ...
      <div ref={navRef} className="relative flex justify-center items-end">
        ...
        {!isVisible && (
          <button
            ...
            className="w-10 h-10 bg-blue-600 text-white rounded-full flex items-center justify-center shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-300 z-20 -translate-y-2"
          >
            <Plus
        ...
        {isVisible && (
          <div
            className={`origin-center transition-all duration-300 ease-in-out px-4 transform
              ...
              max-w-md h-16 bg-white border border-gray-200 rounded-full shadow-md dark:bg-gray-700 dark:border-gray-600 overflow-hidden flex items-center justify-between`}
          >
