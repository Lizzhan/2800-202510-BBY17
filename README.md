...
* Addition of ingredient markers that aren't adjustable unless you are an admin.
* More implementation of AI to suggest serious recipes using user's ingredients if there isn't any such recipes that exist in Recipedia's database. 
...
## 8. Front End Details and additional plugins:
    React + Vite
